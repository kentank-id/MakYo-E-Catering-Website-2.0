...
$data = mysqli_query($conn, "SELECT * FROM menumakanan WHERE id=$id");
...
if (isset($_POST["submit2"])) {
    if (!isset($_POST["jumlah"])) {
        ...
        mysqli_query($conn, "INSERT INTO tempmakan SET nama='" . $nama . "', jumlah='" . $jumlah . "', harga='" . $harga . "'");
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="body-card">
                ...
                <h1><?= $row['nama'] ?></h1>
                <p><?= $row['rincian'] ?></p>
                <h3 class="harga"><?= $row['harga'] ?> / porsi</h3>
                <div class="rating">
                    <?php
